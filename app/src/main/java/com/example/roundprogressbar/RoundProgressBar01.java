...
public class RoundProgressBar01 extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        otherColor = mTypedArray.getColor(R.styleable.RoundProgressBar_otherColor,Color.RED);
    ...
    protected void onDraw(Canvas canvas){
        ...
        RectF oval = new RectF(centre - radius+10,centre - radius+10,centre+radius-10,centre+radius-10);
        switch (style){
            case STROKE:{
    ...
    public void setCircleColr(int cricleColor){
